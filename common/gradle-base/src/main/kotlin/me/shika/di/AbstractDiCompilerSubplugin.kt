...
abstract class AbstractDiCompilerSubplugin: KotlinGradleSubplugin<AbstractCompile> {
    override fun apply(
        project: Project,
        ...
        val sources = File(project.buildDir, "generated/source/me.shika.di-compiler/$sourceSetName/")
